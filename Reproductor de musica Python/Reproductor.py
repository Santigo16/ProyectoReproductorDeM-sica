...
async def main (page: ft.Page):
    ...
    page.title = "Reprodutor de Música"
    page.bgcolor = ft.Colors.BLUE_GREY_900
    page.padding = 20
    titulo = ft.Text(value="Reproductor de Música", size=30, color=ft.Colors.WHITE) 

    pygame.mixer.init()
    playlist = [Song(f) for f in os.listdir(r"C:\Users\EQUIPO\Documents\Reproductor de musica Python\canciones") if f.endswith(".mp3")]
    
    def load_song():
       pygame.mixer.music.load(os.path.join(r"C:\Users\EQUIPO\Documents\Reproductor de musica Python\canciones", playlist[current_song_index].filename))
    ...
    duration = ft.Text(value="00.00", color=ft.Colors.WHITE60)
    ...
    prev_button = ft.IconButton(icon= ft.Icons.SKIP_PREVIOUS, on_click= lambda e: change_song(-1), icon_color= ft.Colors.WHITE)
